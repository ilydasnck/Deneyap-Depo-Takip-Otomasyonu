        ...
        <form onSubmit={submit} className="space-y-4">
          <label className="block text-xs font-medium text-zinc-600 dark:text-slate-400">
            ...
            <select
              ...
              className="mt-1 w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm dark:border-slate-600 dark:bg-slate-800"
            >
          ...
          {url.trim() ? (
            <div className="overflow-hidden rounded-xl border border-zinc-200 dark:border-slate-600">
              <p className="bg-zinc-50 px-2 py-1 text-xs text-zinc-500 dark:bg-slate-800 dark:text-slate-400">
                Önizleme
              </p>
          ...
          <div className="flex gap-2 pt-2">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 rounded-xl border border-zinc-200 py-2.5 text-sm font-semibold dark:border-slate-600"
            >
              Vazgeç
            </button>
            <button
              type="submit"
              className="flex-1 rounded-xl bg-gradient-to-r from-[#B71C1C] to-[#D32F2F] py-2.5 text-sm font-semibold text-white shadow"
            >
              Kaydet
            </button>
          </div>
